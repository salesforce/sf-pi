...
- **LLM tools:** _none_
- **Providers:** _none_
- **Events/hooks:** `session_start`, `session_shutdown`, `model_select`, `session_compact`, `session_info_changed`, `thinking_level_select`, `turn_end`, `agent_end`, `before_agent_start`, `context`
