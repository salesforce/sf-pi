...
- Known high-value native tool mutations are mediated before execution through the same Safety Kernel and HITL path, including first-slice Agent Script lifecycle, SF Flow activation/deactivation, Data 360, Apex, Slack Canvas, and SF Browser commit surfaces.
