...
| `sf-herdr`                | Managed profile file: `<globalAgentDir>/sf-pi/herdr/preferences.json`.                                                                                      | Workflow mode, default pane placement, selected workflow/lane, lane enablement, and lane lifecycle.          | Save in place. `sf_herdr_plan` reads the managed profile for later plans.                                                                                                             |
