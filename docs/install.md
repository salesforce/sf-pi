...
SF Pi's supported Pi range is `>=0.87.0 <1.0.0`. `/sf-pi doctor` reports
...
| Pi `>=0.87.0 <1.0.0` | peer dependency, runtime-floor checks, and nightly exact-version compatibility jobs        |
