...
export function registerTldrawCanvasTool(pi: ExtensionAPI): void {
  pi.registerTool<typeof Params>({
    ...
    promptGuidelines: [
      ...
      "Use the installed Salesforce diagrams guide path declared in <sf_engineering_constitution> for document selection, preserve/relayout semantics, and completion criteria.",
    ],
    parameters: Params,
