...
export declare function createDiagnostic(
  rangeOrNode: Range$1 | Parsed<object> | SyntaxNode,
  message: string,
  severity?: DiagnosticSeverity,
  code?: string,
  data?: Diagnostic["data"],
): Diagnostic;
export declare function undefinedReferenceDiagnostic(
  range: Range$1,
  message: string,
...
export declare function typeMismatchDiagnostic(
  range: Range$1,
  message: string,
  expectedType: string,
  actualType: string,
...
export declare function parseTemplateParts(
  node: SyntaxNode,
 ...
 */
export declare function decomposeMemberExpression(
  expr: unknown,
...
export declare function emitChildren(
  children: BlockChild[],
  ctx: EmitContext,
  sep?: string,
): string;
 ...
 */
export declare function extractChildren(
...
export declare abstract class TypedDeclarationBase extends AstNodeBase {
  ...
  __children: BlockChild[];
  constructor(data: { type: Expression; defaultValue?: Expression; properties?: BlockCore });
}
...
export declare function parseCommentNode(
  node: SyntaxNode,
  attachment?: CommentAttachment,
): Comment$1;
 ...
 */
export declare function buildKindToSchemaKey(
 ...
 */
export declare function addBuilderMethods<
  T extends FieldType,
...
export declare const StringValue: FieldType<TStringValue> &
  BuilderMethods<readonly ["string", "generic"], TStringValue, TStringValue> &
  StringConstraintMethods<readonly ["string", "generic"], TStringValue, TStringValue> &
  GenericConstraintMethods<readonly ["string", "generic"], TStringValue, TStringValue>;
...
export declare const NumberValue: typeof NumberValueNode &
  BuilderMethods<readonly ["number", "generic"], unknown, unknown> &
  NumberConstraintMethods<readonly ["number", "generic"], unknown, unknown> &
  GenericConstraintMethods<readonly ["number", "generic"], unknown, unknown>;
...
export declare const BooleanValue: typeof BooleanValueNode &
  BuilderMethods<readonly ["generic"], unknown, unknown> &
  GenericConstraintMethods<readonly ["generic"], unknown, unknown>;
...
export declare const ProcedureValue: typeof ProcedureValueNode &
  BuilderMethods<readonly [], unknown, unknown>;
 ...
 */
export declare function Sequence<T extends Schema>(
  blockType: BlockFactory<T>,
): SingularFieldType<SequenceNode, SequenceNode> &
  BuilderMethods<readonly ["sequence"], SequenceNode, SequenceNode> &
  SequenceConstraintMethods<readonly ["sequence"], SequenceNode, SequenceNode>;
/**
 * Create a FieldType for expression-only sequences.
 * Mapping elements produce diagnostics.
 */
export declare function ExpressionSequence(): SingularFieldType<SequenceNode, SequenceNode> &
  BuilderMethods<readonly ["sequence"], SequenceNode, SequenceNode> &
  SequenceConstraintMethods<readonly ["sequence"], SequenceNode, SequenceNode>;
export declare function Block(kind: string): BlockFactory<Record<never, never>>;
export declare function Block<T extends Schema>(
  kind: string,
  inputSchema: T,
  options?: BlockFactoryOptions,
): BlockFactory<T>;
export declare function NamedBlock(kind: string): NamedBlockFactory<Record<never, never>>;
export declare function NamedBlock<T extends Schema>(
  kind: string,
  inputSchema: T,
  opts?: NamedBlockOpts,
): NamedBlockFactory<T>;
 ...
 * ```
 */
export declare function CollectionBlock<
  T extends Schema,
  V extends Record<string, Schema> = Record<never, never>,
>(entryBlock: NamedBlockFactory<T, V>, opts?: CollectionBlockOpts): CollectionBlockFactory<T, V>;
/**
 ...
 * ```
 */
export declare function NamedCollectionBlock<
  T extends Schema,
  V extends Record<string, Schema> = Record<never, never>,
>(
...
export declare function TypedMap<T extends TypedDeclarationBase = TypedDeclarationBase>(
  kind: string,
 ...
 */
export declare function emitDocument<S extends Record<string, FieldType>>(
...
export declare function emitDocument(
  parsed: Record<string, unknown>,
  schema: Record<string, FieldType>,
  options?: {
    tabSize?: number;
...
export declare const VariablePropertiesBlock: BlockFactory<{
  description: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
  label: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
  is_required: ConstrainedBuilder<readonly ["generic"], unknown, unknown>;
}>;
...
export declare const ActionBlock: NamedBlockFactory<
  {
    ...
    target: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
    source: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
  },
  Record<never, never>
>;
...
export declare function getGlobalScopes(
  ctx: SchemaContext,
 ...
 */
export declare function getSymbolMembers(
...
export declare class DependencyResolutionError extends Error {
  ...
  constructor(
    ...
    cyclicDependencies?: string[] | undefined,
  );
}
 ...
 */
export declare function findDefinitionAtPosition(
  ast: AstRoot,
  line: number,
  character: number,
  ctx: SchemaContext,
 ...
 */
export declare function findReferencesAtPosition(
  ast: AstRoot,
  line: number,
  character: number,
 ...
 */
export declare function findAllReferences(
  ast: AstRoot,
  namespace: string,
  name: string,
  ctx: SchemaContext,
...
export declare function walkDefinitionKeys(
  ast: AstRoot,
  callback: (
    namespace: string,
    name: string,
 ...
 */
export declare function findEnclosingScope(
  ast: AstRoot,
  line: number,
  character: number,
  index?: PositionIndex,
...
export declare function getAvailableNamespaces(
  ctx: SchemaContext,
  scope?: ScopeContext,
): CompletionCandidate[];
/**
 ...
 */
export declare function getCompletionCandidates(
  ast: AstRoot,
  namespace: string,
  ctx: SchemaContext,
  scope?: ScopeContext,
 ...
 */
export declare function getFieldCompletions(
  ast: AstRoot,
  line: number,
  character: number,
  ctx: SchemaContext,
 ...
 */
export declare function getValueCompletions(
  line: number,
  _character: number,
  ctx: SchemaContext,
  source: string,
 ...
 */
export declare function generateFieldSnippet(
  fieldName: string,
  fieldType: FieldType,
  opts?: SnippetOptions,
): string | undefined;
 ...
 */
export declare function resolveSchemaField(
  path: string[],
  schema: Record<string, SchemaFieldInfo | SchemaFieldInfo[]>,
 ...
 */
export declare function formatSchemaHoverMarkdown(
  path: string[],
 ...
 */
export declare function formatKeywordHoverMarkdown(
  keyword: string,
  kind: "modifier" | "type",
 ...
 */
export declare function findKeywordInfo(
  keyword: string,
 ...
 */
export declare function resolveHover<N>(
  root: N,
  line: number,
  character: number,
  schema: Record<string, SchemaFieldInfo | SchemaFieldInfo[]>,
 ...
 */
export declare function recurseAstChildren(
  value: unknown,
 ...
 */
export declare function forEachExpressionChild(
  obj: AstNodeLike,
 ...
 */
export declare function dispatchAstChildren(
  value: unknown,
  ctx: ScopeContext,
  onExpression: ((obj: AstNodeLike, ctx: ScopeContext) => void) | null,
  recurse: (child: unknown, ctx: ScopeContext, key: string, parent: unknown) => void,
): ScopeContext;
/** Walk the entire AST visiting every expression node with scope context. */
export declare function walkAstExpressions(
  value: unknown,
 ...
 */
export declare function formatSuggestionHint(
  message: string,
...
export declare function resolveColinearAction(raBlock: { value?: unknown }): string | null;
/** Create a lint diagnostic with the standard source tag and optional suggestion. */
export declare function lintDiagnostic(
  range: Range$1,
  message: string,
  severity: DiagnosticSeverity,
  code: string,
 ...
 */
export declare function resolveDialect(
  source: string,
 ...
 */
export declare const CAPTURE_MAP: Record<
  string,
  {
    type: number;
    modifiers: number;
...
export declare function createLanguageService(config: { dialect: DialectConfig }): LanguageService;
export declare function parseAndLint(
  node: SyntaxNode,
  dialect: DialectConfig,
  options?: {
...
export declare const ContextBlock: BlockFactory<{
  memory: BlockFactory<{
    enabled: ConstrainedBuilder<readonly ["generic"], unknown, unknown>;
  }>;
}>;
export declare const AFActionsBlock: CollectionBlockFactory<
  Omit<
    {
      description: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
      label: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
  ...
  > & {
    source: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
    require_user_confirmation: ConstrainedBuilder<readonly ["generic"], unknown, unknown>;
    include_in_progress_indicator: ConstrainedBuilder<readonly ["generic"], unknown, unknown>;
    progress_indicator_message: ConstrainedBuilder<
      readonly ["string", "generic"],
      TStringValue,
      TStringValue
    >;
    inputs: TypedMapFactory<TypedDeclarationBase>;
...
export declare const SecurityBlock: BlockFactory<{
  sharing_policy: BlockFactory<{
    use_default_sharing_entities: ConstrainedBuilder<readonly ["generic"], unknown, unknown>;
    custom_sharing_entities: ConstrainedBuilder<readonly ["sequence"], SequenceNode, SequenceNode>;
  }>;
  verified_customer_record_access: BlockFactory<{
    use_default_objects: ConstrainedBuilder<readonly ["generic"], unknown, unknown>;
    additional_objects: ConstrainedBuilder<readonly ["sequence"], SequenceNode, SequenceNode>;
  }>;
}>;
declare const AFTopicBlock: NamedBlockFactory<
  {
    actions: CollectionBlockFactory<
      Omit<
        {
          description: ConstrainedBuilder<
            readonly ["string", "generic"],
            TStringValue,
            TStringValue
          >;
    ...
    model_config: BlockFactory<{
      model: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
      params: BlockFactory<{}>;
    }>;
    security: BlockFactory<{
      sharing_policy: BlockFactory<{
        use_default_sharing_entities: ConstrainedBuilder<readonly ["generic"], unknown, unknown>;
        custom_sharing_entities: ConstrainedBuilder<
          readonly ["sequence"],
          SequenceNode,
          SequenceNode
        >;
    ...
    before_reasoning: ConstrainedBuilder<readonly [], unknown, unknown>;
    after_reasoning: ConstrainedBuilder<readonly [], unknown, unknown>;
    reasoning: BlockFactory<{
      instructions: ConstrainedBuilder<readonly [], unknown, unknown>;
      actions: CollectionBlockFactory<
        Omit<
          {
            description: ConstrainedBuilder<
    ...
    system: BlockFactory<
      Pick<
        {
          instructions: ConstrainedBuilder<
            readonly ["string", "generic"],
            TStringValue,
            TStringValue
          >;
          messages: BlockFactory<{
            welcome: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
            error: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
          }>;
        },
        "instructions"
      >
    >;
    schema: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
  },
  Record<never, never>
>;
declare const AFSubagentBlock: NamedBlockFactory<
  ...
  Record<never, never>
>;
declare const AFStartAgentBlock: NamedBlockFactory<
  Omit<
    {
      before_reasoning: ConstrainedBuilder<readonly [], unknown, unknown>;
      after_reasoning: ConstrainedBuilder<readonly [], unknown, unknown>;
...
export declare const KnowledgeBlock: BlockFactory<{
  citations_url: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
  rag_feature_config_id: ConstrainedBuilder<
    readonly ["string", "generic"],
    TStringValue,
    TStringValue
  >;
  citations_enabled: ConstrainedBuilder<readonly ["generic"], unknown, unknown>;
}>;
export declare const ConnectionBlock: NamedBlockFactory<
  {
    adaptive_response_allowed: ConstrainedBuilder<readonly ["generic"], unknown, unknown>;
    escalation_message: ConstrainedBuilder<
      readonly ["string", "generic"],
      TStringValue,
      TStringValue
    >;
    instructions: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
    outbound_route_type: ConstrainedBuilder<
      readonly ["string", "generic"],
      TStringValue,
      TStringValue
    >;
    outbound_route_name: ConstrainedBuilder<
      readonly ["string", "generic"],
      TStringValue,
      TStringValue
    >;
...
export declare const PronunciationDictEntryBlock: BlockFactory<{
  grapheme: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
  phoneme: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
  type: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
}>;
export declare const InboundKeywordsBlock: BlockFactory<{
  keywords: ConstrainedBuilder<readonly ["sequence"], SequenceNode, SequenceNode>;
}>;
declare const SpeakUpConfigBlock: BlockFactory<{
  speak_up_first_wait_time_ms: ConstrainedBuilder<readonly ["number", "generic"], unknown, unknown>;
  speak_up_follow_up_wait_time_ms: ConstrainedBuilder<
    readonly ["number", "generic"],
    unknown,
    unknown
  >;
  speak_up_message: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
}>;
declare const EndpointingConfigBlock: BlockFactory<{
  max_wait_time_ms: ConstrainedBuilder<readonly ["number", "generic"], unknown, unknown>;
}>;
...
declare const AdditionalConfigsBlock: BlockFactory<{
  speak_up_config: BlockFactory<{
    speak_up_first_wait_time_ms: ConstrainedBuilder<
      readonly ["number", "generic"],
      unknown,
      unknown
    >;
    speak_up_follow_up_wait_time_ms: ConstrainedBuilder<
      ...
      unknown
    >;
    speak_up_message: ConstrainedBuilder<
      readonly ["string", "generic"],
      TStringValue,
      TStringValue
    >;
...
declare const VoiceModalitySchema: {
  readonly inbound_filler_words_detection: ConstrainedBuilder<
    readonly ["generic"],
    unknown,
    unknown
  >;
  ...
  readonly voice_id: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
  readonly outbound_speed: ConstrainedBuilder<readonly ["number", "generic"], unknown, unknown>;
  readonly outbound_style_exaggeration: ConstrainedBuilder<
    readonly ["number", "generic"],
    unknown,
    unknown
  >;
  readonly outbound_stability: ConstrainedBuilder<readonly ["number", "generic"], unknown, unknown>;
  readonly outbound_similarity: ConstrainedBuilder<
    readonly ["number", "generic"],
    unknown,
    unknown
  >;
  readonly pronunciation_dict: ConstrainedBuilder<
    readonly ["sequence"],
    SequenceNode,
    SequenceNode
  >;
  readonly outbound_filler_sentences: ConstrainedBuilder<
    readonly ["sequence"],
    SequenceNode,
    SequenceNode
  >;
...
declare const ModalityBlock: NamedBlockFactory<
  Record<never, never>,
  Record<never, never> &
    Record<
      "voice",
      {
        ...
        readonly voice_id: ConstrainedBuilder<
          readonly ["string", "generic"],
          TStringValue,
          TStringValue
        >;
        readonly outbound_speed: ConstrainedBuilder<
          readonly ["number", "generic"],
          unknown,
          unknown
        >;
        readonly outbound_style_exaggeration: ConstrainedBuilder<
          ...
          unknown
        >;
        readonly outbound_stability: ConstrainedBuilder<
          readonly ["number", "generic"],
          unknown,
          unknown
        >;
...
export declare const AgentforceSchema: {
  config: BlockFactory<
    Omit<
      ...
      | "role"
      | "planner_type"
      | "additional_parameter__reset_to_initial_node"
      | "additional_parameter__DISABLE_GROUNDEDNESS"
      | "debug"
      | "max_tokens"
      | "temperature"
      | "agent_template"
      ...
      | "user_locale"
    > & {
      developer_name: ConstrainedBuilder<
        readonly ["string", "generic"],
        TStringValue,
        TStringValue
      >;
      agent_label: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
      agent_description: ConstrainedBuilder<
        readonly ["string", "generic"],
        TStringValue,
        TStringValue
      >;
      agent_type: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
      agent_id: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
      agent_name: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
      default_agent_user: ConstrainedBuilder<
        readonly ["string", "generic"],
        TStringValue,
        TStringValue
      >;
      agent_version: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
      enable_enhanced_event_logs: ConstrainedBuilder<readonly ["generic"], unknown, unknown>;
      company: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
      role: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
      planner_type: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
      additional_parameter__reset_to_initial_node: ConstrainedBuilder<
        readonly ["generic"],
        unknown,
        unknown
      >;
      additional_parameter__DISABLE_GROUNDEDNESS: ConstrainedBuilder<
        readonly ["generic"],
        unknown,
        unknown
      >;
      debug: ConstrainedBuilder<readonly ["generic"], unknown, unknown>;
      max_tokens: ConstrainedBuilder<readonly ["number", "generic"], unknown, unknown>;
      temperature: ConstrainedBuilder<readonly ["number", "generic"], unknown, unknown>;
      agent_template: ConstrainedBuilder<
        readonly ["string", "generic"],
        TStringValue,
        TStringValue
      >;
      outbound_flow: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
      user_locale: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
    }
  >;
  ...
  connected_subagent: NamedCollectionBlockFactory<
    {
      ...
      label: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
      description: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
      loading_text: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
      inputs: TypedMapFactory<TypedDeclarationBase>;
    },
    Record<never, never>
  >;
  modality: NamedCollectionBlockFactory<
    Record<never, never>,
    Record<never, never> &
      Record<
        "voice",
        {
          ...
          readonly additional_configs: BlockFactory<{
            ...
            endpointing_config: BlockFactory<{
              max_wait_time_ms: ConstrainedBuilder<
                readonly ["number", "generic"],
                unknown,
                unknown
              >;
  ...
  subagent: NamedCollectionBlockFactory<
    ...
    Record<never, never>
  >;
  start_agent: NamedCollectionBlockFactory<
    Omit<
      {
        before_reasoning: ConstrainedBuilder<readonly [], unknown, unknown>;
        after_reasoning: ConstrainedBuilder<readonly [], unknown, unknown>;
  ...
  language: BlockFactory<{
    default_locale: ConstrainedBuilder<readonly ["string", "generic"], TStringValue, TStringValue>;
    additional_locales: ConstrainedBuilder<
      readonly ["string", "generic"],
      TStringValue,
      TStringValue
    >;
    all_additional_locales: ConstrainedBuilder<readonly ["generic"], unknown, unknown>;
  }>;
};
...
export type ComponentResultMap = {
  [K in keyof AgentforceSchema]: InferEntryType<AgentforceSchema[K]> extends BlockCore
    ? InferEntryType<AgentforceSchema[K]>
    : never;
};
/**
...
declare class Document$1 {
   ...
   */
  mutate(
    fn: (ast: ParsedAgentforce, helpers: MutationHelpers<ParsedAgentforce>) => void,
    label?: string,
  ): this;
  /** Add/replace a singular root-level block. Handles `__children`. */
  setField<K extends SingularKeys>(
    key: K,
    value: InferFieldType<AgentforceSchema[K]>,
    label?: string,
  ): this;
...
export declare function parseComponent<K extends keyof AgentforceSchema>(
  source: string,
  kind: K,
 ...
 */
export declare function parseComponentDebug(
  source: string,
  kind: "action" | "actions" | "reasoning_actions",
): ParseComponentDebugResult<ComponentResultMap[keyof ComponentResultMap]>;
export declare function parseComponentDebug<K extends keyof AgentforceSchema>(
  source: string,
  kind: K,
 ...
 */
export declare function emitComponent(
...
export declare function mutateComponent<T extends BlockCore>(
  block: T,
    ...
    global_configuration: z.ZodObject<
      {
        ...
        context_variables: z.ZodOptional<
          z.ZodNullable<
            z.ZodArray<
              z.ZodObject<
                {
        ...
        security: z.ZodOptional<
          z.ZodNullable<
            z.ZodObject<
              {
                verified_customer_record_access: z.ZodOptional<
                  z.ZodNullable<
                    z.ZodObject<
                      {
        ...
        z.ZodObject<
          {
            ...
            system_messages: z.ZodOptional<
              z.ZodNullable<
                z.ZodArray<
                  z.ZodObject<
                    {
                      message: z.ZodOptional<z.ZodNullable<z.ZodString>>;
                      message_type: z.ZodOptional<
                        z.ZodNullable<
                          z.ZodEnum<{
                            Welcome: "Welcome";
                            Error: "Error";
              ...
              >
            >;
            modality_parameters: z.ZodOptional<
              z.ZodNullable<
                z.ZodObject<
                  {
                    voice: z.ZodOptional<
                      z.ZodNullable<
                        z.ZodObject<
                          {
                            inbound_filler_words_detection: z.ZodOptional<
                              z.ZodNullable<z.ZodBoolean>
                            >;
                            inbound_keywords: z.ZodOptional<
                              z.ZodNullable<
                                z.ZodObject<
                                  {
                            ...
                            outbound_filler_sentences: z.ZodOptional<
                              z.ZodNullable<
                                z.ZodArray<
                                  z.ZodObject<
                                    {
                                      filler_sentences: z.ZodRecord<
                                        z.ZodString,
                            ...
                            pronunciation_dict: z.ZodOptional<
                              z.ZodNullable<
                                z.ZodObject<
                                  {
                                    pronunciations: z.ZodArray<
                                      z.ZodObject<
                                        {
                              ...
                              >
                            >;
                            additional_configs: z.ZodOptional<
                              z.ZodNullable<
                                z.ZodObject<
                                  {
                                    speak_up_config: z.ZodOptional<
                                      z.ZodNullable<
                                        z.ZodObject<
                                          {
                                            speak_up_first_wait_time_ms: z.ZodOptional<
                                              z.ZodNullable<z.ZodInt>
                                            >;
                                            speak_up_follow_up_wait_time_ms: z.ZodOptional<
                                              z.ZodNullable<z.ZodInt>
                                            >;
                                            speak_up_message: z.ZodOptional<
                                      ...
                                      >
                                    >;
                                    endpointing_config: z.ZodOptional<
                                      z.ZodNullable<
                                        z.ZodObject<
                                          {
                                            max_wait_time_ms: z.ZodOptional<
                                              z.ZodNullable<z.ZodInt>
                                            >;
                                          },
                                          z.core.$strip
                        ...
                        z.ZodObject<
                          {
                            default_locale: z.ZodOptional<
                              ...
                              >
                            >;
                            additional_locales: z.ZodOptional<
                              z.ZodNullable<
                                z.ZodArray<
                                  z.ZodEnum<{
                                    id: "id";
            ...
            nodes: z.ZodArray<
                ...
                z.ZodUnion<
                  readonly [
                    z.ZodIntersection<
                      ...
                      z.ZodObject<
                        {
                          model_configuration: z.ZodOptional<
                            z.ZodNullable<
                              z.ZodObject<
                                {
                            ...
                            >
                          >;
                          before_reasoning_iteration: z.ZodOptional<
                            z.ZodNullable<
                              z.ZodArray<
                                z.ZodIntersection<
                                  z.ZodUnion<
                                        ...
                                        z.ZodObject<
                                          {
                                            ...
                                            >;
                                            target: z.ZodString;
                                            bound_inputs: z.ZodOptional<
                                              z.ZodNullable<z.ZodRecord<z.ZodString, z.ZodUnknown>>
                                            >;
                                            llm_inputs: z.ZodOptional<
                                              z.ZodNullable<z.ZodArray<z.ZodString>>
                                            >;
                                            enabled: z.ZodOptional<z.ZodUnknown>;
                                            state_updates: z.ZodOptional<
                                              z.ZodNullable<
                          ...
                          description: z.ZodOptional<z.ZodNullable<z.ZodString>>;
                          before_reasoning: z.ZodOptional<
                            z.ZodNullable<
                              z.ZodArray<
                                z.ZodIntersection<
                                  z.ZodUnion<
                                        ...
                                        z.ZodObject<
                                          {
                                            ...
                                            name: z.ZodString;
                                            description: z.ZodOptional<z.ZodNullable<z.ZodString>>;
                                            input_parameters: z.ZodOptional<
                                              z.ZodNullable<
                                                z.ZodArray<
                                                  z.ZodObject<
                                                    {
                                                      ...
                                                      complex_data_type_name: z.ZodOptional<
                                                        z.ZodNullable<z.ZodString>
                                                      >;
                                                      is_list: z.ZodOptional<
                                                        z.ZodNullable<z.ZodBoolean>
                                                      >;
                                                      required: z.ZodOptional<
                                                        z.ZodNullable<z.ZodBoolean>
                                                      >;
                                                      is_user_input: z.ZodOptional<
                                                        z.ZodNullable<z.ZodBoolean>
                                                      >;
                          ...
                          post_tool_call: z.ZodOptional<
                            ...
                            >
                          >;
                          after_all_tool_calls: z.ZodOptional<
                            z.ZodNullable<
                              z.ZodArray<
                                z.ZodIntersection<
                                  z.ZodUnion<
                          ...
                          on_exit: z.ZodOptional<
                            ...
                            >
                          >;
                          action_definitions: z.ZodOptional<
                            z.ZodNullable<
                              z.ZodArray<
                                z.ZodObject<
                                  {
                                    ...
                                    require_user_confirmation: z.ZodDefault<
                                      z.ZodOptional<z.ZodBoolean>
                                    >;
                                    include_in_progress_indicator: z.ZodDefault<
                                      z.ZodOptional<z.ZodBoolean>
                                    >;
                                    progress_indicator_message: z.ZodOptional<
                                      z.ZodNullable<z.ZodString>
                                    >;
                                    invocation_target_type: z.ZodString;
                                    invocation_target_name: z.ZodString;
                                    input_type: z.ZodDefault<
                                      z.ZodOptional<
                                        z.ZodArray<
                                          z.ZodObject<
                                            {
                                          ...
                                          z.ZodObject<
                                            {
                                              ...
                                              >;
                                              is_list: z.ZodOptional<z.ZodNullable<z.ZodBoolean>>;
                                              is_used_by_planner: z.ZodOptional<
                                                z.ZodNullable<z.ZodBoolean>
                                              >;
                                              is_displayable: z.ZodOptional<
                                                z.ZodNullable<z.ZodBoolean>
                                              >;
                                            },
                                            z.core.$strip
                      ...
                      z.ZodObject<
                        {
                          ...
                          label: z.ZodOptional<z.ZodNullable<z.ZodString>>;
                          description: z.ZodOptional<z.ZodNullable<z.ZodString>>;
                          invocation_target_type: z.ZodDefault<
                            ...
                            z.ZodObject<
                              {
                                ...
                                description: z.ZodOptional<z.ZodNullable<z.ZodString>>;
                                state_updates: z.ZodOptional<
                                  z.ZodNullable<z.ZodArray<z.ZodRecord<z.ZodString, z.ZodUnknown>>>
                                >;
                              },
                              z.core.$strip
                            >
              ...
              >
            >;
            knowledge_definitions: z.ZodOptional<
              z.ZodNullable<
                z.ZodArray<
                  z.ZodObject<
                    {
                      ...
                      adl_configuration: z.ZodObject<
                        {
                          ...
                          referenced_retrievers: z.ZodOptional<
                            z.ZodNullable<
                              z.ZodArray<
                                z.ZodObject<
                                  {
                                    ...
                                    grounding_source_type: z.ZodOptional<
                                      z.ZodNullable<z.ZodString>
                                    >;
              ...
              >
            >;
            legacy_knowledge_action: z.ZodOptional<
              z.ZodNullable<
                z.ZodObject<
                  {
                    developer_name: z.ZodString;
                  ...
                  z.ZodObject<
                    {
                      ...
                      outbound_route_configs: z.ZodOptional<
                        z.ZodNullable<
                          z.ZodArray<
                            z.ZodObject<
                              {
                                escalation_message: z.ZodOptional<z.ZodNullable<z.ZodString>>;
                                outbound_route_type: z.ZodDefault<
                                  z.ZodOptional<
                                    z.ZodEnum<{
                          ...
                          z.ZodObject<
                            {
                              ...
                              voice_id: z.ZodOptional<z.ZodNullable<z.ZodString>>;
                              outbound_speed: z.ZodOptional<z.ZodNullable<z.ZodNumber>>;
                              outbound_style_exaggeration: z.ZodOptional<
                        ...
                        adl_configuration: z.ZodObject<
                          {
                            ...
                            ai_grounding_library_id: z.ZodString;
                            ai_grounding_library_name: z.ZodString;
                            ai_grounding_library_namespace: z.ZodOptional<
                              z.ZodNullable<z.ZodString>
                            >;
                            ai_grounding_library_fully_qualified_name: z.ZodString;
                            referenced_retrievers: z.ZodOptional<
 ...
 */
declare function serializeWithSourceMap(
  output: unknown,
  ranges: RangeMap,
