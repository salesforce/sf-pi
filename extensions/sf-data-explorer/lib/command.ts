...
export function parseCommandArgs(args: string, defaultOrg = DEFAULT_ORG): ParsedCommandArgs {
  ...
  // Supported forms:
  //   /sf-data-explorer soql my-org            -> org=my-org
  //   /sf-data-explorer soql Account my-org    -> object=Account, org=my-org
  //   /sf-data-explorer sql ssot__X__dlm my-org -> object=ssot__X__dlm, org=my-org
