...
- [ ] Pi 0.81 runtime adoption through behavior/deletion gates; the runtime window, credential containment, M2A–M2F corrections, and E4 SF Skills parity evidence are implemented, while Gateway Provider replacement, Browser progressive-tool evaluation, the update coordinator, and interactive native login remain pending ([implementation plan](./docs/pi-081-runtime-adoption-plan.md))
